...
<div class="row">
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <span class="info-box-text"><a href="/odlms/admin/?page=tests">Tests</a></span>
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text"><a href="/odlms/admin/?page=tests">Booked Appointment</a></span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text"><a href="/odlms/admin/?page=user/list">Registered Users</a></span>
            <span class="info-box-number text-right">
                <?php 
